//Magic DeathMatch/Freeroam by Lezduit
//Beta V1.0
...
new Teleport[][e_Teleports]=
{
	...
	//{"Bank","/Bank","!áøåê äáà ìáð÷",3093.9722,-1808.1891,9.6328,0.6992,3093.9722,-1808.1891,8.1328,0.6992,0,0,1,0,true,false},
 ...
 if(!strcmp(cmdtext,"/VHelp",true))
	{
		...
		return ShowPlayerDialog(playerid,DIALOG_INF,DIALOG_STYLE_MSGBOX,"V.I.P System",szDialog,"ñâéøä","");
	}
